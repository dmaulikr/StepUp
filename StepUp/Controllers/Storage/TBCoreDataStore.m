...
static NSString *const TBCoreDataModelFileName = @"StepUp";
...
@property (nonatomic, strong) NSManagedObjectContext *inMemoryContext;
...
{
    return [[self defaultStore] inMemoryContext];
}
...
{
    if (!_inMemoryContext) {
        _inMemoryContext = [[NSManagedObjectContext alloc] initWithConcurrencyType:NSMainQueueConcurrencyType];
        ...
        _inMemoryContext.persistentStoreCoordinator = persistentStoreCoordinator;
    }
